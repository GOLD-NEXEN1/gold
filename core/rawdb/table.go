// Copyright 2018 The go-goldereum Authors
...
import (
	"github.com/goldereum/go-goldereum/golddb"
)
...
func NewTable(db golddb.Database, prefix string) golddb.Database {
	return &table{
		db:     db,
		prefix: prefix,
	}
...
func (t *table) NewIterator() golddb.Iterator {
...
// not exist).
func (t *table) NewIteratorWithStart(start []byte) golddb.Iterator {
	return t.db.NewIteratorWithStart(start)
}

// NewIteratorWithPrefix creates a binary-alphabetical iterator over a subset
// of database content with a particular key prefix.
func (t *table) NewIteratorWithPrefix(prefix []byte) golddb.Iterator {
...
func (t *table) NewBatch() golddb.Batch {
...
func (b *tableBatch) Replay(w golddb.KeyValueWriter) error {
