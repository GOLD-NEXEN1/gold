...
|   `puppgold`   | a CLI wizard that aids in creating a new goldereum network.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
If you'd like to contribute to go-goldereum, please fork, fix, commit and send a pull request
